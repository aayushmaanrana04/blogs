...
<div class="min-h-dvh flex flex-col bg-card-bg text-text m-5 rounded-xl">
    <header class="w-full px-6 border-b border-border">
        <div class="max-w-2xl mx-auto py-6 flex justify-between items-start">
            <div>
                ...
                >
                    Thoughtful essays on design, culture, and life
                </p>
            </div>
